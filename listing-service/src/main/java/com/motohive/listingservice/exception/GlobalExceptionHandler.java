...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleEnquiryNotFound(EnquiryNotFoundException ex) {
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
				       .body(buildError(HttpStatus.NOT_FOUND, ex.getMessage()));
	}
	
	@ExceptionHandler(DuplicateActiveListingException.class)
	public ResponseEntity<ErrorResponse> handleDuplicateListing(DuplicateActiveListingException ex) {
